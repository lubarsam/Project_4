...
#set_property -dict {PACKAGE_PIN Y17 IOSTANDARD LVCMOS33} [get_ports LED3]
...
## Pmod Header JB
set_property -dict {PACKAGE_PIN W14 IOSTANDARD LVCMOS33} [get_ports LCD_SCL]
set_property -dict {PACKAGE_PIN Y14 IOSTANDARD LVCMOS33} [get_ports LCD_SDA]
#set_property -dict {PACKAGE_PIN T11 IOSTANDARD LVCMOS33} [get_ports Btn2]
#set_property -dict {PACKAGE_PIN T10 IOSTANDARD LVCMOS33} [get_ports Btn3]
...
set_property -dict { PACKAGE_PIN U14   IOSTANDARD LVCMOS33 } [get_ports { uart_RX }]; #IO_L11P_T1_SRCC_34 Sch=ck_io[0]
set_property -dict { PACKAGE_PIN V13   IOSTANDARD LVCMOS33 } [get_ports { uart_TX }]; #IO_L3N_T0_DQS_34 Sch=ck_io[1]
set_property -dict { PACKAGE_PIN T14   IOSTANDARD LVCMOS33 } [get_ports { KB_clk }]; #IO_L5P_T0_34 Sch=ck_io[2]
set_property -dict { PACKAGE_PIN T15   IOSTANDARD LVCMOS33 } [get_ports { KB_data }]; #IO_L5N_T0_34 Sch=ck_io[3]
...
## ChipKit I2C
set_property -dict {PACKAGE_PIN P16 IOSTANDARD LVCMOS33} [get_ports 7seg_scl]
set_property -dict {PACKAGE_PIN P15 IOSTANDARD LVCMOS33} [get_ports 7seg_sda]
...
#set_property -dict {PACKAGE_PIN L19 IOSTANDARD LVCMOS33} [get_ports o2Lowp]
#set_property -dict {PACKAGE_PIN M19 IOSTANDARD LVCMOS33} [get_ports AIN0]
#set_property -dict {PACKAGE_PIN N20 IOSTANDARD LVCMOS33} [get_ports AIN1]
#set_property -dict {PACKAGE_PIN P20 IOSTANDARD LVCMOS33} [get_ports AIN3]
#set_property -dict { PACKAGE_PIN P19   IOSTANDARD LVCMOS33 } [get_ports { e }]; #IO_L13N_T2_MRCC_34 Sch=user_dio[5]
#set_property -dict { PACKAGE_PIN R19   IOSTANDARD LVCMOS33 } [get_ports { e }]; #IO_0_34 Sch=user_dio[6]
#set_property -dict { PACKAGE_PIN T20   IOSTANDARD LVCMOS33 } [get_ports { e }]; #IO_L15P_T2_DQS_34 Sch=user_dio[7]
...
connect_debug_port u_ila_0/probe0 [get_nets [list {inst_i2c_user_logic/cont[0]} {inst_i2c_user_logic/cont[1]} {inst_i2c_user_logic/cont[2]} {inst_i2c_user_logic/cont[3]} {inst_i2c_user_logic/cont[4]} {inst_i2c_user_logic/cont[5]} {inst_i2c_user_logic/cont[6]} {inst_i2c_user_logic/cont[7]} {inst_i2c_user_logic/cont[8]} {inst_i2c_user_logic/cont[9]} {inst_i2c_user_logic/cont[10]} {inst_i2c_user_logic/cont[11]} {inst_i2c_user_logic/cont[12]} {inst_i2c_user_logic/cont[13]} {inst_i2c_user_logic/cont[14]} {inst_i2c_user_logic/cont[15]} {inst_i2c_user_logic/cont[16]} {inst_i2c_user_logic/cont[17]} {inst_i2c_user_logic/cont[18]} {inst_i2c_user_logic/cont[19]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe1]
set_property port_width 1 [get_debug_ports u_ila_0/probe1]
connect_debug_port u_ila_0/probe1 [get_nets [list {inst_i2c_user_logic/i2c_data_rw[3]}]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe2]
set_property port_width 1 [get_debug_ports u_ila_0/probe2]
connect_debug_port u_ila_0/probe2 [get_nets [list inst_i2c_user_logic/ena]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe3]
set_property port_width 1 [get_debug_ports u_ila_0/probe3]
connect_debug_port u_ila_0/probe3 [get_nets [list inst_i2c_user_logic/busy_prev]]
create_debug_port u_ila_0 probe
set_property PROBE_TYPE DATA_AND_TRIGGER [get_debug_ports u_ila_0/probe4]
set_property port_width 1 [get_debug_ports u_ila_0/probe4]
connect_debug_port u_ila_0/probe4 [get_nets [list inst_i2c_user_logic/reset_n]]
